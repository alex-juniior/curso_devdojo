...
public class CompletableFutureTest04 {
    ...
    private static void searchPricesWithDiscount(StoreServiceWithDiscount service){
        ...
        List<String> stores = List.of("Store 1","Store 2","Store 3","Store 1","Store 4");
//        stores.forEach(s -> System.out.println(service.getPriceSync(service.getPriceSync(s))));
        stores.stream()
        ...
        System.out.printf("Time passed to searchPricersSync %dms%n", (end - start));
    }
    ...
    private static void searchPricesWithDiscountAsync(StoreServiceWithDiscount service){
        ...
        List<CompletableFuture<String>> completableFutures = stores.stream()
                ...
                // Instantianting a new quote from the string generaterd by getPryceSync
