...
class PersonServiceTest {
    ...
    @Test
    @DisplayName("A person should be adult when age is greater or eqaull than 18")
    ...
    void filterRemovingNotAdult_ReturnListWithAdultOnly_WhenListOfPersonWithAdultPassed() {
